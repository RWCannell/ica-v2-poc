...
The Nextflow pipeline that implements the aforementioned bash scripts can be found over [here](pipelines/nextflow/single_file_upload/main.nf). This pipeline is still undergoing tests.   
