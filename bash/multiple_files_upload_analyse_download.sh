...
file_directory="$HOME/Documents/ica_data_uploads/fasta/multiple_fasta_files"
file_name=""
...
# Loop through files in the file directory
for file_path in "$file_directory"/*; do
  if [ -f "$file_path" ]; then
    ...
    printf "[$time_stamp]: "
    printf "Uploading '$file_name' from path '$file_path'... \n"
